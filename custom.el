(custom-set-variables
 ...
 '(org-plantuml-jar-path "/usr/local/Cellar/plantuml/1.2019.13/libexec/plantuml.jar" nil nil "Customized with use-package ob-plantuml")
...
(custom-set-faces
 ...
 '(org-headline-done ((t (:inherit default :weight bold :foreground "#FDF4C1" :font "Source Sans Pro" :strike-through t))))
 ...
 '(org-scheduled-previously ((t (:weight bold :underline nil :foreground "#fb4933"))))
