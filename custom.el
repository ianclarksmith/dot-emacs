(custom-set-variables
 ...
 '(org-plantuml-jar-path "/usr/local/Cellar/plantuml/1.2019.12/libexec/plantuml.jar" nil nil "Customized with use-package ob-plantuml")
