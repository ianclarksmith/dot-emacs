(custom-set-variables
 ...
 '(cider-repl-history-file "~/.emacs.d/cider-history" nil nil "Customized with use-package cider")
 '(cider-repl-history-size 5000 nil nil "Customized with use-package cider")
 '(cider-repl-pop-to-buffer-on-connect t nil nil "Customized with use-package cider")
 '(cider-repl-result-prefix "; => " nil nil "Customized with use-package cider")
 '(cider-repl-use-clojure-font-lock t nil nil "Customized with use-package cider")
 '(cider-repl-use-pretty-printing nil nil nil "Customized with use-package cider")
 '(cider-repl-wrap-history t nil nil "Customized with use-package cider")
 '(cider-show-error-buffer nil nil nil "Customized with use-package cider")
 ...
 '(org-super-agenda-groups (quote ((:auto-dir-name t))) t)
 '(org-tags-column 0)
